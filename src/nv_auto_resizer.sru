...
public function long of_min (long a, long b)
public function long of_max (long a, long b)
end prototypes
...
choose case apo_object.typeof()
	...
	case line!
		ls_datatype = "line"
	case rectangle!
		ls_datatype = "rectangle"
	case oval!
		ls_datatype = "oval"
	case roundrectangle!
		ls_datatype = "roundrectangle"
	case else
		debugBreak()
		ls_datatype = "others"		
end choose
...
public function long of_min (long a, long b);if a > b then 
	return b
end if
...
public function long of_max (long a, long b);if a > b then
	return a
end if
